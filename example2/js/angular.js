...
function createInjector(modulesToLoad) {
  var INSTANTIATING = {},
      ...
      var instanceCache = {};
      instanceCache.$injector = createInternalInjector(instanceCache, invoker);
      var instanceInjector = instanceCache.$injector;
      function invoker(servicename) {
		  var provider = providerInjector.get(servicename + providerSuffix);
		  return instanceInjector.invoke(provider.$get, provider);
      };
      providerInjector.name = "providerInjector";
      instanceInjector.name = "instanceInjector";
